var storyPasture = {
    ...
    gridLoad : function () {
        $("#jqGrid").jqGrid({
            ...
            width: ($(".card-body").width() - 5) < 1200 ? 1200 : ($(".card-body").width() - 5),
            pager: "#pager",
            pgbuttons: true,
            pginput : true,
            shrinkToFit: true,
...
var jqGridForm = {
    colModel : [
        ...
        { label: '목장</br>모임',    	    name: 'pastureMeetYn',      align: 'center', width: 45, formatter: formatter.YnDesc 	},
        { label: '리더</br>모임',    	    name: 'leaderYn',           align: 'center', width: 45, formatter: formatter.YnDesc 	},
        { label: '리더모임</br>불참사유',   name: 'leaderDesc',         align: 'center', width: 65 	},
        { label: '금요</br>예배',    	    name: 'fridayWorshipYn',    align: 'center', width: 45, formatter: formatter.YnDesc 	},
        { label: '성경',    	            name: 'bibleCount',         align: 'center', width: 30 	},
        { label: '큐티',    	            name: 'qtCount',            align: 'center', width: 30 	},
        { label: '새벽</br>기도',    	    name: 'dawnPrayCount',      align: 'center', width: 30 	},
        ...
        { label: '등록일',       	        name: 'createDate',         align: 'center', width: 90, 	hidden: false },
        { label: '수정일',       	        name: 'updateDate',         align: 'center', width: 90, 	hidden: false },
